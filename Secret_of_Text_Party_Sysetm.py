...
score = 0
party = []
Randi = {'Name': 'Randi' ,'Player Level': 1, 'Player Exp': 0, 'Next Level': 25, 'player_stats' : {'Strength': 1, 'Dexterity': 1, 'Endurance': 1, 'attack' :[5, 12], 'health': 100}}
Purim = {'Name': 'Purim' ,'Player Level': 1, 'Player Exp': 0, 'Next Level': 25, 'player_stats' : {'Strength': 1, 'Dexterity': 1, 'Endurance': 1, 'attack' :[5, 12], 'health': 100}}
Sprite = {'Name': 'Sprite','Player Level': 1, 'Player Exp': 0, 'Next Level': 25, 'player_stats' : {'Strength': 1, 'Dexterity': 1, 'Endurance': 1, 'attack' :[5, 12], 'health': 100}}
party.append(Randi)
party.append(Purim)
party.append(Sprite)
...
def battle_system(room, monsters):
    ...
    while Randi['player_stats']['health'] and monster_health >0:
        for character in party:
            if "Rusty Sword" in player_inventory:
                if sword_count == 1:
                    Randi["player_stats"]['attack'] = (Randi["player_stats"]['attack'][0] + 12) , (Randi["player_stats"]['attack'][1] + 18)
                    sword_count = sword_count + 1
            if "Mana Sword" in player_inventory:
                Randi["player_stats"]['attack'] = (Randi["player_stats"]['attack'][0] + 1000) , (Randi["player_stats"]['attack'][1] + 1100)
