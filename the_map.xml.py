# XML Parser/Data Access Object the_map.xml.py
"""AUTO-GENERATED Source file for the_map.xml.py"""
import xml.sax
import Queue
...
class key_q2class(Q2API.xml.base_xml.XMLNode):
    def __init__(self, attrs):
        self.level = 4
        self.path = [None, u'map', u'building', u'exit']
        Q2API.xml.base_xml.XMLNode.__init__(self, "key", attrs, None, [])
...
class exits_q2class(Q2API.xml.base_xml.XMLNode):
    def __init__(self, attrs):
        self.level = 3
        self.path = [None, u'map', u'building']
        Q2API.xml.base_xml.XMLNode.__init__(self, "exits", attrs, None, [])

class hp_q2class(Q2API.xml.base_xml.XMLNode):
    def __init__(self, attrs):
        self.level = 3
        self.path = [None, u'map', u'player']
        Q2API.xml.base_xml.XMLNode.__init__(self, "hp", attrs, None, [])
...
class npc_q2class(Q2API.xml.base_xml.XMLNode):
    def __init__(self, attrs):
        self.level = 3
        self.path = [None, u'map', u'building']
        self.hp = []
        Q2API.xml.base_xml.XMLNode.__init__(self, "npc", attrs, None, [])
...
class NodeHandler(xml.sax.handler.ContentHandler):
    ...
    def startElement(self, name, attrs): # creating the node along the path being tracked
        ...
        if name == "":
            ...
            self.obj_depth.append(exits_q2class(p_attrs))
            ...
            self.obj_depth.append(hp_q2class(p_attrs))
            ...
            self.obj_depth.append(npc_q2class(p_attrs))
            ...
            self.obj_depth.append(key_q2class(p_attrs))
    ...
    def endElement(self, name): # need to append the node that is closing in the right place
        ...
        if name == "":
            ...
            self.obj_depth[-2].exits.append(self.obj_depth[-1]) #  make this object a child of the next object up...
            self.obj_depth[-2].children.append(self.obj_depth[-1]) #  put a reference in the children list as well
            self.obj_depth.pop() # remove this node from the list, processing is complete
            self.char_buffer = []
            ...
            self.obj_depth[-2].hp.append(self.obj_depth[-1]) #  make this object a child of the next object up...
            self.obj_depth[-2].children.append(self.obj_depth[-1]) #  put a reference in the children list as well
            self.obj_depth.pop() # remove this node from the list, processing is complete
            self.char_buffer = []
            ...
            self.obj_depth[-2].npc.append(self.obj_depth[-1]) #  make this object a child of the next object up...
            self.obj_depth[-2].children.append(self.obj_depth[-1]) #  put a reference in the children list as well
            self.obj_depth.pop() # remove this node from the list, processing is complete
            self.char_buffer = []
            ...
            self.obj_depth[-2].key.append(self.obj_depth[-1]) #  make this object a child of the next object up...
            self.obj_depth[-2].children.append(self.obj_depth[-1]) #  put a reference in the children list as well
            self.obj_depth.pop() # remove this node from the list, processing is complete
            self.char_buffer = []
